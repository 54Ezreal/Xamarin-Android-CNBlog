...
{
    [Activity(Label = "MyPostsActivity")]
	public class MyPostsActivity : BaseActivity,OnRefreshListener
	{
		...
		public  void  onLoadMore(PullToRefreshLayout pullToRefreshLayout)
		{
			BaseService.ExeRequest(async () =>
			{
				...
				var moreArticles = await BlogService.GetBolggerPosts(CommonHelper.token, CommonHelper.userInfo.BlogApp, pageIndex);
